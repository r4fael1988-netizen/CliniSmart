...
async function finalSync() {
  console.log("Sincronizando n8n com o Segredo Universal...");
  ...
  try {
    ...
    if (updateResponse.ok) { console.log("n8n ATUALIZADO com Novo Secret!"); }
